...
import 'package:image_panning/model/card.dart';
          ...
          children: [
            Container(
              ...
              child: TextButton(
                ...
                child: Image.asset('assets/change_icon.png'),
              ),
            ),
            const SizedBox(
              height: 5,
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          for (var profImage in response.data['result']) {
                            setState(() {
                              print(profImage);
                              cardDesign = Result.fromJson(profImage);

                              print(cardDesign.uid);

                              // print(infomation.customImageCardDesignInfo.profileBannerImageURL);
                            });
